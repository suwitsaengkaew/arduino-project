...
//  dmd.drawChar(  1,  1, msg[0], GRAPHICS_NORMAL );
//  dmd.drawChar(  11,  1, msg[1], GRAPHICS_NORMAL );
//  dmd.drawChar(  22,  1, msg[2], GRAPHICS_NORMAL );
//  dmd.drawChar(  33,  1, msg[3], GRAPHICS_NORMAL );
//  dmd.drawChar(  44,  1, msg[4], GRAPHICS_NORMAL );
//  dmd.drawChar(  55,  1, msg[5], GRAPHICS_NORMAL );
